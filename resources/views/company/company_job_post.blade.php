...
<div class="job-bx submit-resume">
	<div class="job-bx-title clearfix">
		...
		<form method="post" action="{{route('company.jobsave')}}">
			@csrf
			<div class="row">
				...
				<div class="col-lg-6 col-md-6">
					<div class="form-group">
						...
						<select class="bs-select-hidden" name="category_id" required>
				...
				<div class="col-lg-6 col-md-6">
					<div class="form-group">
						...
						<select class="bs-select-hidden" name="type" required>
				...
				<div class="col-lg-6 col-md-6">
					<div class="form-group">
						<label>Status</label>
						<select class="bs-select-hidden" name="status" required>
			...
			<div class="row">
				<div class="col-lg-12 col-md-12">
					<div class="form-group">
						...
						<textarea id="summernote" name="description" class="form-control" cols="50" rows="10" required>
