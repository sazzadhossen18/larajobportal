				...
				<form action="{{route('candidate.avatar')}}" method="post" enctype="multipart/form-data">
                    @csrf
								...
								<li><a href="{{route('my.job')}}">
										...
										<li><a href="{{route('job.favourite.candidate')}}" class="active">
						...
						<div class="col-xl-9 col-lg-8 m-b30">
							<div class="job-bx save-job table-job-bx clearfix">
								<div class="job-bx-title clearfix">
									<h5 class="font-weight-700 pull-left text-uppercase">Saved Jobs</h5>
	...
	@foreach($saves as $save)
		...
		<tr>
			...
			<td class="job-name">
				...
				<form action="{{route('job.apply',$save->id)}}" method="post">
       		 @csrf
    		<div class="card-body">
			...
			<td class="job-links">
				...
				<a href="{{route('job.favourite.delete',$save->id)}}"><i class="fa fa-trash"></i></a>
			</td>
		</tr>
